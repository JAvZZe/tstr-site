...
> **Project**: TSTR.site (Testers & Testing Services & Products Directory)
...
task_id = add_task("TSTR.site", "Task description", assigned_to="opencode")
# ... do work ...
...
2. **Project Bootstrap**: `./bootstrap.sh TSTR.site`
