...
INSERT INTO categories (id, name, slug, parent_id, description) VALUES
  (gen_random_uuid(), 'Valve & Fitting Testing', 'hydrogen-infrastructure-testing/valve-fitting', '2817126e-65fa-4ddf-8ec6-dbedb021001a', 'ISO 19880-3 valve qualification at 700 bar. Pressure cycling, material compatibility, and leak testing.'),
  (gen_random_uuid(), 'Hose & Seal Testing', 'hydrogen-infrastructure-testing/hose-seal', '2817126e-65fa-4ddf-8ec6-dbedb021001a', 'ISO 19880-5 hose and permeation testing. Cryogenic-capable seal qualification at -253°C.'),
  (gen_random_uuid(), 'Tank & Pressure Vessel Testing', 'hydrogen-infrastructure-testing/tank-pressure', '2817126e-65fa-4ddf-8ec6-dbedb021001a', 'Type III/IV composite tank testing per UN ECE R134. Burst and cycling tests up to 1000 bar.'),
  (gen_random_uuid(), 'Hydrogen Embrittlement Testing', 'hydrogen-infrastructure-testing/embrittlement', '2817126e-65fa-4ddf-8ec6-dbedb021001a', 'ISO 11114-4 materials qualification. Metallurgical analysis of metals and elastomers under gaseous H2.'),
  (gen_random_uuid(), 'Hydrogen Purity Testing', 'hydrogen-infrastructure-testing/purity', '2817126e-65fa-4ddf-8ec6-dbedb021001a', 'ISO 14687 fuel quality specification. Impurity analysis for fuel-cell grade hydrogen.')
ON CONFLICT (slug) DO NOTHING;
