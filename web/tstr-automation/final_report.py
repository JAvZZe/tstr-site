...
print(f"States Searched: 15 (Alabama through Indiana)")
print(f"Listings Found: 285")
print(f"Listings Processed: 200 (limited)")
print(f"New Listings Saved: 0 (all were duplicates from previous scrape)")
print(f"Duplicates Detected: 200")
print(f"Failed: 0")
print(f"New Locations Created: 11 (states and cities)")
