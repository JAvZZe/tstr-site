#!/usr/bin/env python3
"""
Final A2LA laboratory extraction compilation for all 64 PIDs
Updates with Claude web search findings
"""
...
EXTRACTED_DATA = {
    ...
    "12A618F6-8114-4994-A522-26D9F1AA0986": {
        ...
        "confidence": "low",
        "notes": "FTIR spectroscopy, thermal analysis (DSC, TGA), rubber testing - PDF inaccessible"
    },
    ...
    "77917E06-92F9-44A7-9B08-AE3073409575": {
        ...
        "confidence": "medium",
        "notes": "Medical grade plastics, metals, biomaterials testing per FDA GLP"
    },
    ...
    "A10F1CF1-37CC-4599-9BAA-735E28EAA330": {
        ...
        "confidence": "medium",
        "notes": "Composite plastics metals testing - ASTM D695, D2344, D3039, D3518"
    },
    ...
    "42653955-6E26-43AF-BEF1-02DD1FF1CFED": {
        "cert": "1123.07",
        "org": "Element Materials Technology Kokomo",
        "city": "Kokomo",
        "state": "IN",
        "scope": "Vibration Testing",
        "confidence": "high",
        "notes": "1815 Touby Pike, vibration testing electro-dynamic equipment"
    },
    ...
    "1E6C92C1-E5BA-4FC9-8C30-0287C8B288AD": {
        ...
        "scope": "Metallurgy",
        "confidence": "low",
        "notes": "Withdrawn accreditation - telecommunications equipment"
    },
    ...
    "1D5CD78D-2A8B-4EC2-AFA8-B9C80F0AACAF": {
        "cert": "3873.01",
        "org": "ALSOUHUB LABORATORIES",
        "city": "Al Qurain",
        "state": "Kuwait",
        "scope": "Chemical Petroleum Water",
        "confidence": "high",
        "notes": "Building No. 344 Street-17 Block-1, petroleum and water chemical analysis"
    },
    ...
    "4F2D1698-48D6-4E25-868E-7A98D7894A7B": {
        "cert": "2927.01",
        "org": "Eurofins Food Chemistry Testing Des Moines",
        "city": "Des Moines",
        "state": "IA",
        "scope": "Food Microbiological Chemical",
        "confidence": "high",
        "notes": "2200 Rittenhouse St Suite 150, food feeds dietary supplements testing"
    },
    "A2DD8B53-2BE6-440D-BB9C-06197262AF88": {
        ...
        "scope": "Chemical",
        "confidence": "medium",
        "notes": "Lead and heavy metals testing in paints/coatings/products CPSC compliance"
    },
    ...
    "E29B82D6-20E9-4B03-8F27-20E07A2545B9": {
        "cert": "1109.06",
        "org": "GM TEST LABORATORIES",
        "city": "Milford",
        "state": "MI",
        "scope": "Environmental",
        "confidence": "high",
        "notes": "3300 General Motors Road, automotive emission testing"
    },
    ...
    "12B5296B-1C26-4A2B-9834-86DED1337C27": {
        ...
        "scope": "Environmental",
        "confidence": "medium",
        "notes": "Environmental vibration testing aerospace defense telecom"
    },
    ...
    "2B874E91-662F-456E-8863-A0BF6274D308": {
        ...
        "scope": "Construction",
        "confidence": "low",
        "notes": "Fiber reinforced plastics composite materials testing"
    },
...
def create_final_jsonl():
    ...
    for pid, data in EXTRACTED_DATA.items():
        record = {
            ...
            "country": "USA" if data.get("state", "") not in ["Kuwait", ""] else "Kuwait" if data.get("state") == "Kuwait" else "",
...
def create_final_report():
    ...
    found = sum(1 for d in EXTRACTED_DATA.values() if d.get("org") not in ["Not Found", ""])
    not_found = total - found

    report = f"""# A2LA LABORATORY DATA EXTRACTION - FINAL REPORT

## Executive Summary
- **Total PIDs Processed**: 64
- **Successfully Extracted**: {found}
- **Partial/Incomplete**: {low_conf}
...
|------------------|-------|-----------|
| High | {high_conf} | {high_conf/total*100:.1f}% |
| Medium | {medium_conf} | {medium_conf/total*100:.1f}% |
| Low | {low_conf} | {low_conf/total*100:.1f}% |
...
if __name__ == "__main__":
    output_file, count = create_final_jsonl()
    report_file, report_text = create_final_report()

    print("=" * 80)
    print("FINAL A2LA EXTRACTION COMPLETE")
    print("=" * 80)
    print(f"\n✓ Output JSONL: {output_file}")
    print(f"  Records: {count}/64 PIDs")
    print(f"\n✓ Report: {report_file}")
    print("\n" + report_text[:1500] + "\n...")
    print("\n" + "=" * 80)
