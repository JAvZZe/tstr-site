...
1. **Plan First**: Always start with a clear `task_boundary` and `implementation_plan.md` for any non-trivial task. Clarify what success is so that you can verify completion.
