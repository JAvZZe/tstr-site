...
**Result:**
- Sitemap reduced from 63 → 61 URLs
...
- Anon key: `[REDACTED_LEGACY_JWT].`
- Service role key: `[REDACTED_LEGACY_JWT].`
...
|----------|------|----------|------------|
| Hydrogen Infrastructure Testing | hydrogen-infrastructure-testing | 3 | ✅ |
| Oil & Gas Testing | oil-gas-testing | 18 | ✅ |
| Pharmaceutical Testing | pharmaceutical-testing | 108 | ✅ |
| Biotech Testing | biotech-testing | 0 | ❌ (auto-excluded) |
| Environmental Testing | environmental-testing | 32 | ✅ |
| Materials Testing | materials-testing | 22 | ✅ |
...
5. **Analytics**
   ...
   - Monitor conversion from browse → submit listing
