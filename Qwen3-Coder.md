# Qwen3-Coder.md - TSTR.directory Project
...
task_id = add_task("TSTR.directory", "Task description", assigned_to="qwen3-coder")
# ... do work ...
...
### Best Use Cases for TSTR.directory
...
## Qwen3-Coder Specific Tasks for TSTR.directory
