# Security & Health Report - TSTR.site
...
**Supabase CLI Check**: `npx supabase db lint` ✅ **PASSED** (No schema errors)
...
- **Result**: ❌ **FAILED** (`pg_stat_statements` not installed)
